...
Trace plots and autocorrelation diagnostics indicate reasonable mixing across all chains for parameters of inferential interest; convergence summaries are reported in Table~\ref{tab:mcmc_diagnostics}.
